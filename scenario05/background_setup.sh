...
kubectl apply -f kubernetes-goat/scenarios/kubernetes-goat-home/deployment.yaml
sleep 15
...
echo 'kubectl port-forward $POD_NAME --address 0.0.0.0 0.0.0.0 1234:80 > /dev/null 2>&1 &'>> startup.sh
